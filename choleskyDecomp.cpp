...
int main(){
    ...
    cout << "Cholesky Error: " << sqrt(error) << "\n\n";
    cout << "Cholesky Number of Operations: " << count << "\n";
    cout << "Cholesky Number of Operations After Decomposition: " << decompositionCount << "\n";
    cout << "Total Number of Operations: " << count + decompositionCount;
}
